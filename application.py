...
def home():
    ...
    # arr1= arr.values
    # arr1=arr.rename({'Loan_Amount':'f0','Applicant_Income':'f1',
    #                     'Coapplicant_Income':'f2','Loan_Amount_Term':'f3',
    #                     'Credit_History':'f4',
    #                     'Property_Area_Rural':'f5',
    #                     'Property_Area_Semiurban':'f6',
    #                     'Property_Area_Urban':'f7'})
    
    #[Loan_Amount,Applicant_Income,Coapplicant_Income,Loan_Amount_Term,Credit_History,Property_Area_Rural,Property_Area_Semiurban,Property_Area_Urban]
